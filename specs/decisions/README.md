...
| `34.core-package-boundaries.md`                                   | Accepted    | G0/G1 Core Extracted + G2 Execution/Data Runtime Active                                             | Runtime、NodeGraph、Animation、Data、协议 adapter、Router、Browser/Remote Runtime、PIR React Renderer、Workspace Outbox、local replica 与 Workspace Semantic Index 已有稳定 owner 与 revision-bound composition；server/edge 三协议 gateway、pull-driven stream、Vue product target 与 SourceTrace debugger 继续复用这些边界。                                                      | 让更多 transport、stream resume/credential renewal 与 Remote cross-target journey 继续遵守 package owner 边界。                          |
...
| `45.data-operation-and-environment-reference-foundation.md`       | Accepted    | Canonical Data + Runtime/Target/Security First Verticals Implemented                                | Data current contract、typed Workspace/Semantic、PIR/Collection binding/lifecycle、mock/live adapter、环境授权、三协议 finite gateway、public pull-driven stream，以及 React/Vue × Preview/Test/Build 有界 matrix 已建立。                                                                                                                                                          | 完成 stream reconnect/resume、Secret credential renewal 与更多 transport/incremental semantics。                                         |
| `46.auth-and-server-runtime.md`                                   | Accepted    | A0-A12 Implemented；A13-A16 Configured / Evidence pending                                           | current contract、Remote/Test/isolated、Secret/KMS、A13 revision-fenced source adoption、A14 AWS SDK envelope/static-to-cloud rewrap、A15 exact read + one-shot Secret，以及 A16 canonical viewer role/exact read-only durable authority 已建立。                                                                                                                                   | A13/A15/A16 rootless 与 A14 live AWS evidence、第三方 Auth/其他 permission/role、其他 managed KMS、debugger 与完整 leak/Golden closure。 |
| `47.binary-asset-pipeline.md`                                     | Accepted    | B0-B7 First Verticals Implemented                                                                   | reference-only Workspace blob、local/cloud store、transform/scanner/delivery、retention、Git/LFS、runtime import/replace 与 Browser product Gate 已落地。                                                                                                                                                                                                                           | 第二 vendor、完整 raster/format/public delivery 与跨 target 产品旅程。                                                                   |
| `48.controlled-vue-vite-portability-target.md`                    | Accepted    | Controlled G2 Data First Vertical Implemented / Expanded by ADR 54                                  | Vue 3/Vite 使用同一 Data current model、standalone runtime、Executable Snapshot v6 与 Remote codec，并通过独立 install/vue-tsc/test/build/Chrome CRUD Gate。                                                                                                                                                                                                                        | 当前产品面扩展见 ADR 54；公共 Target SDK 留待后续阶段。                                                                                  |
| `49.data-stream-and-source-debugger.md`                           | Accepted    | Server/Edge GraphQL/AsyncAPI Stream + Source Debugger First Vertical Implemented                    | subscription current contract、pull/cursor/backpressure、SSE/NDJSON Backend gateway、Remote frame/generation fence、`data-stream` capability、sanitized Network SourceTrace 与 exact Workspace navigation 已落地。                                                                                                                                                                  | reconnect/resume cursor、Secret credential renewal、更多 transport 与 incremental collection semantics 继续 fail closed。                |
...
| `52.remote-execution-regional-disaster-recovery.md`               | Accepted    | Regional PostgreSQL / Worker / Traffic DR First Vertical Implemented                                | repeatable-read exact checkpoint、shared request drain/exclusive epoch cutover、standby HTTP/readiness hard cut、durable evidence、同 lease continuation、attempt+1 reclaim 与 Terminal generation replacement 已落地。                                                                                                                                                             | 首次真实跨 Region cloud RPO/RTO drill、批量 checkpoint、operator UI 与自动 runbook。                                                     |
...
| `54.vue-vite-product-surface-and-authenticated-catalog-golden.md` | Accepted    | Current-contract Product Vertical Implemented                                                       | Vue PIR/Route/Auth/Server/Asset compiler、Export/Test/Blueprint target selector、deterministic authenticated Catalog CRUD + PNG Chrome journey，以及 Remote Preview/Test/Build snapshot/capability/codec Gate 已落地。                                                                                                                                                              | 真实 Remote authenticated live Catalog、layout/outlet、跨 target Asset delivery 与 public Target SDK。                                   |
