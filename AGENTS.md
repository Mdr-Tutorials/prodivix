...
| 内容                                        | Canonical 文档                                                                                                                                                                                                                                                                                                                                                                                            |
| ------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| G0/G1/G2 当前完成状态                       | [`specs/roadmap/current-status.md`](specs/roadmap/current-status.md)                                                                                                                                                                                                                                                                                                                                      |
...
1. Canonical Workspace VFS 是作者态唯一真相。PIR、Route、NodeGraph、Animation、Data Source、Code、Token、Asset 与 Config 是由各领域 owner 管理的文档或清单；PIR 不是整个项目的单一巨型 JSON。
