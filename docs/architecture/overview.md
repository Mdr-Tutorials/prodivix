...
- Canonical Workspace VFS 是唯一作者态真相；PIR、Route、NodeGraph、Animation、Data、Code、Token、Asset 与 Config 由各自 owner 管理。PIR 不是整个项目的单一巨型 JSON。
