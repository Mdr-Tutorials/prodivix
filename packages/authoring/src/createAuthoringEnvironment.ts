...
} from './codeArtifactProviderRegistry';
import {
  createCodeSymbolProviderRegistry,
  type CodeSymbolProviderRegistry,
} from './codeSymbolProviderRegistry';
import {
  createAuthoringDiagnosticProviderRegistry,
  type AuthoringDiagnosticProviderRegistry,
} from './authoringDiagnosticProviderRegistry';
import type { AuthoringEnvironment, CodeCompletion } from './authoring.types';
